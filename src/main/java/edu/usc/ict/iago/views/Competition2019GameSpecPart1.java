...
class Competition2019GameSpecPart1 extends GameSpec{
	
	
	
	Competition2019GameSpecPart1(boolean privileged) 
	{
		...
		simpleVHPoints.put(getIssuePluralNames()[3], 3);

...
class Competition2019GameSpecPart2 extends GameSpec{
	
	
	
	Competition2019GameSpecPart2(boolean privileged) 
	{
		...
		simpleVHPoints.put(getIssuePluralNames()[0], 2);
		simpleVHPoints.put(getIssuePluralNames()[1], 3);
		simpleVHPoints.put(getIssuePluralNames()[2], 4);
	...
	public String getNewgameMessage() {
		return "<strong>The items and your preferences have changed!</strong><br><br>  You need to negotiate a trade deal for resources!  <br><br>Click \"View Payoffs\" to view these again. <br><br> You now get 2 points for each bar of iron, <br>3 points for each bar of gold, <br>only 1 point for each barrel of oil,<br> and 4 points for each shipment of spices.";
	}
	

	@Override
	public String getEndgameMessage() {
		return "The game has ended!  Be prepared, a new game will start with the same opponent after a few short questions!";
	}
	...
	public String getStudyName() {
		return "ANAC2019part2";
	}
	
	@Override
	public String getSurvey() {
		return "anac2018survey.jsp";
	}

...
<body>
	...
	<div class="reminder instructions">
		<div id="standardText">
			...
			<br>
			The negotiation consists of 4 items: record crates, antique lamps, Art Deco paintings, and cuckoo clocks. <br>
			<br>
			<div id="ava2">
			...
			<div id="pva2">
			You get <strong>6 points for each box of records, 4 points for each cuckoo clock, 2 points for each painting, and only 1 point for each lamp</strong>.<br>
		...
		<div>
			<img class="instruction-pic" id="instr_relation" alt="Picture of the relation options" src="img/instr_relation.PNG" width="671" height="284" />
		</div>
		<div>
		<br>
		<hr>
